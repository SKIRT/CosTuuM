 ...
 * Copyright (C) 2016, 2020 Bert Vandenbroucke (bert.vandenbroucke@gmail.com)
 *
 ...
 *
 * This random number generator was originally developed as part of the Monte
 * Carlo photoionization code CMacIonize
 * (https://github.com/bwvdnbro/CMacIonize) and was adapted for use with
 * CosTuuM.
 *
